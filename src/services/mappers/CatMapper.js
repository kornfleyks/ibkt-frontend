...
export function mapCat(item) {
  ...
  return {
    ...
    lapCat: columns[CATS.COLUMNS.LAP_CAT]?.text || "Unknown",
    childFriendly: columns[CATS.COLUMNS.CHILD_FRIENDLY]?.text || "Unknown",
    catFriendly: columns[CATS.COLUMNS.CAT_FRIENDLY]?.text || "Unknown",
    dogFriendly: columns[CATS.COLUMNS.DOG_FRIENDLY]?.text || "Unknown",
    indoorOnly: columns[CATS.COLUMNS.INDOOR_ONLY]?.text || "N/A",
