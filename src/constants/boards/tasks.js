...
export const TASKS = {
  ...
  COLUMNS: {
    ...
    DUE_DATE: "date_mm7b7q17", // Due Date | date
    WAITING_REASON: "long_text_mm7b2sxt", // Waiting Reason | long_text
    TASK_DESCRIPTION: "long_text_mm7b858c", // Task Description | long_text
  },
  RELATIONS: {
    OWNER: ["5098492656"],
